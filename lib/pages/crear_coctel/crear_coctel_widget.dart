                ...
                children: [
                      ...
                      child: Container(
                        ...
                        child: Stack(
                          children: [
                            ...
                            if (_model.imagenCoctel == null ||
                                (_model.imagenCoctel?.bytes?.isEmpty ?? true))
                              Column(
                                mainAxisSize: MainAxisSize.max,
                                ...
                                children: [
                                  ...
                                  Align(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'd2njfw50' /* Haz clic para añadir la imagen... */,
                                      ),
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                        FFLocalizations.of(context).getText(
                          'ghmap2vt' /* Tiempo de preparación */,
                        ),
                        style: FlutterFlowTheme.of(context).labelLarge.override(
                              font: GoogleFonts.inter(
                                fontWeight: FontWeight.w600,
