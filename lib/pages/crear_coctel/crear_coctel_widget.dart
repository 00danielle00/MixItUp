...
/// creame una pantalla para crear un cóctel con nombre, descripcion, una
/// imagen, dificultad y que haya un boton que sea crear
///
class CrearCoctelWidget extends StatefulWidget {
  const CrearCoctelWidget({super.key});

  static String routeName = 'crearCoctel';
  static String routePath = '/crearCoctel';

  @override
  State<CrearCoctelWidget> createState() => _CrearCoctelWidgetState();
}

class _CrearCoctelWidgetState extends State<CrearCoctelWidget> {
  late CrearCoctelModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CrearCoctelModel());
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [Colors.white, Color(0xFFFFC25B)],
                      stops: [0.8, 1.0],
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                await RecetasTable().insert({
                                  'esAlcoholica': _model.dropDownValue2,
                                  'nombre': _model.textController1.text,
                                  'dificultad': _model.dropDownValue1,
                                  'imagen': _model.textController3.text,
                                ...
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      title: Text('Crear Cóctel'),
                                      content:
                                          Text('Acabas de crear una receta'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
