                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            FFLocalizations.of(context).getText(
                              'kdxzuvmu' /* Descubre tu próxima bebida fav... */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                ...
                Padding(
                  ...
                  child: FutureBuilder<List<RecetasRow>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<RecetasRow> listViewRecetasRowList = snapshot.data!;
                                              ...
                                              Expanded(
                                                child: wrapWithModel(
                                                  ...
                                                  child: DifficultyWidget(
                                                    key: Key(
                                                      'Keyo5e_${listViewRecetasRow.dificultad!}',
                                                    ),
                                                    difficulty:
                                                        listViewRecetasRow
                                                            .dificultad!,
